                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="custom-file">
                                        <input type="file" value="{{$all_blog->image}}" class="custom-file-input" name="image" id="exampleInputFile">
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" name="title" class="form-control" id="exampleInputPassword1" placeholder="">{{$all_blog->title}}</textarea>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1"></label>
                                <textarea type="text" name="content" class="form-control" id="exampleInputPassword1" placeholder="">{{$all_blog->content}}</textarea>
                            </div>
                        </div>
                        <!-- /.card-body -->
