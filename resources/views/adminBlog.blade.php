                                ...
                                <div class="card" id="my_table">
                                    <div class="form-element mb-0">
                                        <div class="card-header" id="card-header">
                                            <h3 class="card-title">Blogs Overview</h3>
                                            <form action="/addBlog" method="get">
                                                @csrf
                                                <div style="text-align: right;" id="addFaqBtn">

                                                    <button type="submit"><span>Add New</span></button>
                                        ...
                                        <table class="table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>{{$data->content}}</td>
                                                    <td>
                                                        <div class="form-element mb-0" style="padding: 10px;">
                                                            <a href="/edit/{{$data->id}}"><button type="submit" style="margin-top: 10px;"><span>Edit</span></button></a>
                                                            <a href="/delete/{{$data->id}}"><button type="submit" style="margin-top: 15px;"><span>Delete</span></button></a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            </tbody>
                                    ...
                                    <div class="card-footer clearfix">
                                        {{$all_blog ->links('vendor.pagination.bootstrap-4')}}
                                    </div>
                                </div>
                            </div>
                        </div>
