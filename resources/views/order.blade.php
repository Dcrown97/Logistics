...
<!-- Mirrored from kreativdev.com/transpix/transpix/checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 19 Nov 2021 13:21:57 GMT -->
...
<head>
   ...
   <title>Transpix - Transport & Logistic Order</title>
   <!-- favicon -->
...
<body>
   ...
   <!--  breadcrumb end  -->
      ...
      <div class="billing-address" style="margin-bottom: 20px;">
         <div class="container">
            <h4 class="title">Placed Order</h4>
            <div class="row">
               <div class="col-lg-6">
                  <div class="form-element">
                     <h4>Your Order has been placed successfully.</h4>
                     <p>Here is your tracking number: <strong>{{$saved_to_db->tracking_id}}</strong></p>
                  </div>
                  <div class="col-lg-12">
                     <div class="form-element mb-0">
                        <h4>Your Order will be delivered in 7days.</h4>
                     </div>
                  </div>
               </div>
            </div>
