...
<!-- Mirrored from kreativdev.com/transpix/transpix/quote.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 19 Nov 2021 13:18:32 GMT -->
<head>
      <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
      <meta http-equiv="X-UA-Compatible" content="IE=edge" />
      <meta http-equiv="X-UA-Compatible" content="ie=edge">
      <meta name="viewport" content="width=device-width, initial-scale=1.0">
      <title>Transpix - Transport & Logistic Quote</title>
      <!-- favicon -->
               ...
               <div class="col-xl-6 col-lg-6">
                  ...
                  <form method="POST">
                     ...
                     <div class="row">
                        ...
                        <div class="col-lg-6">
                           <div class="form-element"><input name="pickup" type="text" placeholder="Pickup Location"></div>
                           <span>@error('Pickup') {{$message}}@enderror</span>
                        </div>
                        <div class="col-lg-6">
                           <div class="form-element"><input name="dropoff" type="text" placeholder="Dropoff Location"></div>
                           <span>@error('dropoff') {{$message}}@enderror</span>
                        </div>
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                           ...
                           <span>@error('distance') {{$message}}@enderror</span>
                        </div>
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                           ...
                           <span>@error('select') {{$message}}@enderror</span>
         ...
         <div class="container">
            <div class="top-footer">
               <div class="row">
                  ...
                  <div class="offset-xl-2 col-xl-3 col-lg-4">
                     <h4>Useful Links</h4>
            ...
            <div class="bottom-footer">
               <p class="text-center">© Copyrights 2021 Transpix. All rights reserved.</p>
            </div>
         </div>
      </footer>
      <!--   footer section end    -->
...
<!-- Mirrored from kreativdev.com/transpix/transpix/quote.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 19 Nov 2021 13:18:52 GMT -->
</html>