                    ...
                    <form action="" method="post">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <textarea type="text" name="about" class="form-control" id="exampleInputPassword1" placeholder="About">{{$about['about']}}</textarea>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">Mission</label>
                                <textarea type="text" name="mission" class="form-control" id="exampleInputPassword1" placeholder="Mission">{{$about['mission']}}</textarea>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">Vision</label>
                                <textarea type="text" name="vision" class="form-control" id="exampleInputPassword1" placeholder="Vision">{{$about['vision']}}</textarea>
                            </div>
                        </div>
                        <!-- /.card-body -->
